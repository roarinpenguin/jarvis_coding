...
# Sample users and hosts
USERS = ["jdoe", "asmith", "bjones", "cwilliams", "dlee", "emiller", "fchen", "gwang", "admin", "service_account"]
HOSTNAMES = ["DESKTOP-ABC123", "LAPTOP-XYZ789", "SERVER-DC01", "WORKSTATION-005", "DEV-MACHINE-02"]
