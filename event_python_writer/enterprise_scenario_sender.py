...
def send_enterprise_scenario():
    ...
    try:
        ...
        with open('enterprise_attack_scenario.json', 'r') as f:
            scenario = json.load(f)
        print("📝 Loaded existing enterprise attack scenario")
    except:
        # Generate new scenario if file doesn't exist
        print("📝 Generating new enterprise attack scenario...")
