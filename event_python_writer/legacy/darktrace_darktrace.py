#!/usr/bin/env python3
"""
Darktrace Darktrace Logs Event Generator
Generates synthetic Darktrace Darktrace Logs security events for testing
"""
...
def darktrace_darktrace_log():
    """Generate a synthetic Darktrace Darktrace Logs log event."""
    ...
    event = {
        "timestamp": timestamp,
        "vendor": "Darktrace",
        "product": "Darktrace Logs",
        "version": "1.0",
        "event_type": "security_event",
        
        # Common fields that parsers often expect
        "message": f"Sample Darktrace Darktrace Logs event at {timestamp}",
