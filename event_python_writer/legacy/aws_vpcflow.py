#!/usr/bin/env python3
"""
Aws Vpcflow Logs Event Generator
Generates synthetic Aws Vpcflow Logs security events for testing
"""
...
def aws_vpcflow_log():
    """Generate a synthetic Aws Vpcflow Logs log event."""
    ...
    event = {
        "timestamp": timestamp,
        "vendor": "Aws",
        "product": "Vpcflow Logs",
        "version": "1.0",
        "event_type": "security_event",
        
        # Common fields that parsers often expect
        "message": f"Sample Aws Vpcflow Logs event at {timestamp}",
