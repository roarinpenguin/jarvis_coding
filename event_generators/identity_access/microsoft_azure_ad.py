#!/usr/bin/env python3
"""
Microsoft Azure Ad Logs Event Generator
Generates synthetic Microsoft Azure Ad Logs security events for testing
"""
...
def microsoft_azure_ad_log():
    ...
    event = {
        ...
        "message": f"Sample Microsoft Azure Ad Logs event at {timestamp}",
