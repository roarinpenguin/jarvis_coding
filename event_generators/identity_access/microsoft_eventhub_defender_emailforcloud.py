#!/usr/bin/env python3
"""
Microsoft Eventhub Defender Emailforcloud Logs Event Generator
Generates synthetic Microsoft Eventhub Defender Emailforcloud Logs security events for testing
"""
...
ATTR_FIELDS = {
    "vendor": "Microsoft",
    "product": "EventHub Defender Email For Cloud",
    "version": "1.0",
    "category": "email_security"
}

def microsoft_eventhub_defender_emailforcloud_log():
    """Generate a synthetic Microsoft Eventhub Defender Emailforcloud Logs log event."""
    ...
    event = {
        ...
        "message": f"Sample Microsoft Eventhub Defender Emailforcloud Logs event at {timestamp}",
...
if __name__ == "__main__":
    ...
    event = microsoft_eventhub_defender_emailforcloud_log()
